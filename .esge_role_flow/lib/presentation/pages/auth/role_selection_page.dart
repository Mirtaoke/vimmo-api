...
class _RoleSelectionPageState extends State<RoleSelectionPage> {
                        ...
                        GridView.builder(
                          ...
                          gridDelegate:
                              SliverGridDelegateWithFixedCrossAxisCount(
                                crossAxisCount: constraints.maxWidth >= 560
                                    ? 3
                                    : 2,
                                crossAxisSpacing: 8,
                                mainAxisSpacing: 8,
      ...
      child: InkWell(
        ...
        child: AnimatedScale(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: active
                  ? Color.lerp(const Color(0xFF202923), accent, .16)
  ...
  Color _accent(UserRole role) => accents[UserRole.values.indexOf(role)];
