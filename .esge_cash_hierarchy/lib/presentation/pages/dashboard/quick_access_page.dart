...
extension QuickAccessTypeX on QuickAccessType {
  ...
  Color get color => switch (this) {
    ...
    QuickAccessType.prospects => AppColors.azure,
    QuickAccessType.documents => AppColors.purple,
  };
}
...
class _QuickAccessPageState extends State<QuickAccessPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final canCreate = switch (widget.type) {
      QuickAccessType.vouchers => role == UserRole.caissier,
      QuickAccessType.articles => role == UserRole.magasinier,
      QuickAccessType.prospects => role == UserRole.commercial,
      QuickAccessType.documents => false,
    };
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, index) {
                  ...
                  return EsgeFilterChip(
                    ...
                    color: value == 'Tous' ? AppColors.indigo : color,
