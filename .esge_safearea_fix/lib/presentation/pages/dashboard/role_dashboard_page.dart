...
class RoleDashboardPage extends StatelessWidget {
        ...
        child: const Stack(
          ...
          children: [
            ...
            Positioned(
              right: 8,
              top: 7,
              child: CircleAvatar(radius: 3.5, backgroundColor: AppColors.red),
            ),
          ],
        ),
      ),
  ...
  Widget _balanceCard(_DashboardConfig config) => Container(
    ...
    decoration: BoxDecoration(
      gradient: const LinearGradient(
        ...
        colors: [Color(0xFF123B72), Color(0xFF0E8494), Color(0xFF5942C9)],
      ),
          ...
          children: [
            Row(
              children: [
                ...
                EsgeStatusChip('LIVE', color: AppColors.green),
              ],
            ),
            const Spacer(),
            Text(
  ...
  Widget _taskCard(_DashboardConfig config) => Container(
    padding: const EdgeInsets.all(14),
    decoration: BoxDecoration(
      gradient: LinearGradient(
        colors: [AppColors.violet.withValues(alpha: .12), AppColors.surface],
      ),
      borderRadius: BorderRadius.circular(20),
          ...
          child: Ink(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [
                  module.color.withValues(alpha: .10),
                  AppColors.surface,
                ],
              ),
              borderRadius: BorderRadius.circular(19),
              border: Border.all(color: module.color.withValues(alpha: .18)),
            ),
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
