...
abstract final class AppColors {
  static const background = Color(0xFF030908);
  static const background2 = Color(0xFF061310);
  static const navy = Color(0xFF071713);
  static const navyLight = Color(0xFF0B251E);
  static const surface = Color(0xFF0A1D18);
  static const surface2 = Color(0xFF0E2922);
  static const surface3 = Color(0xFF12382D);
  static const line = Color(0xFF1A4035);
  static const lineSoft = Color(0xFF123229);
  static const text = Color(0xFFF5FFF9);
  static const textSoft = Color(0xFFAAC8BA);
  static const muted = Color(0xFF6F9585);
