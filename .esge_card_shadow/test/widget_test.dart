...
void main() {
  ...
  testWidgets('la grille des rôles reste lisible sur petit écran', (
    tester,
  ) async {
  ...
  testWidgets('la priorité du tableau de bord ouvre sa fiche', (tester) async {
    ...
    await tester.scrollUntilVisible(find.text('PRIORITÉ'), 250);
    await tester.tap(find.text('PRIORITÉ'));
